...
////  let genre_ids: ResultsGenre? // return optional([Array])
//
...
////    self.genre_ids = ResultsGenre.init(json: json["genre_ids"])
////    self.genre_ids = json["results"].arrayValue.map({$0["genre_ids"].intValue})
//
